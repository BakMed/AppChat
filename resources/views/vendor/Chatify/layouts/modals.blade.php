...
<div id="imageModalBox" class="imageModal">
  ...
  <div class="app-modal" data-name="settings">
      <div class="app-modal-container">
          ...
          <a href="javascript:void(0)" style="margin-left:24rem;" >
          <span class="{{ Auth::user()->dark_mode > 0 ? 'fas' : 'far' }} ">
  ...
  <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"/>
              ...
              <form id="update-settings" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="app-modal-footer">
                      <a href="php:void(0)" class="app-btn cancel">Cancel</a>
                      <input type="submit" class="app-btn a-btn-success update" value="Save Changes" />
                
                      <!-- <a href="{{ url('logout') }}" class="app-btn a-btn-danger" onclick="return confirm('Are you sure you want to LogOut?') ">
                                {{ __('Log Out') }}
                            </a> -->
                            </div>       
              </form>
